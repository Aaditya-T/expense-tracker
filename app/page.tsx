			...
			<main>
				...
				<div className="briefClass">
					<div className="intro">
						...
						<p>
							Manage Your Finances Effortlessly Gain control over your finances with our user-friendly expense tracker.
							Easily track your spending, set budgets, and achieve your financial goals. Stay organized, save time, and
							make informed decisions about your money. Sign up now to start managing your money smarter!
						</p>
					</div>
				...
				<div className="containerClass">
					...
					<div className="feature">
						...
						<p>
							Provide an interface for users to manually enter their expenses, including date, amount, category, and
							description.
						</p>
					</div>
					<div className="feature">

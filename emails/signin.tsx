...
export const SignInEmail = ({ action_link = '' }: { action_link?: string }) => {
	return (
		<Html>
			<Tailwind>
				<Head />
				<Preview>Sign in link to Kharch Khabri</Preview>
				<Body className="bg-white my-auto mx-auto font-sans">
					<Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
						{/* <Section className="mt-[22px]">
							<Img src={`/Users/aaditya/Desktop/code/expensetracker/public/icons/logo.png`} width="50" height="50" alt="Logo" className="block m-auto" />
						</Section> */}
